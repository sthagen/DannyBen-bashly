...
- Add support for evented file watcher [`357dd255`](https://github.com/bashly-framework/bashly/commit/357dd255)
- Update settings JSON schema with `watch_*` options [`5aba9bef`](https://github.com/bashly-framework/bashly/commit/5aba9bef)
- Add `bold_underlined` to the color library [`0f90ca51`](https://github.com/bashly-framework/bashly/commit/0f90ca51)
- Remove approvals.bash (`bashly add test`) [`f4e8ea62`](https://github.com/bashly-framework/bashly/commit/f4e8ea62)
- Add support for command argfile [`1086e984`](https://github.com/bashly-framework/bashly/commit/1086e984)
- Add argfile example [`5c36a85f`](https://github.com/bashly-framework/bashly/commit/5c36a85f)
- Compare [`v1.3.6..v1.3.7`](https://github.com/bashly-framework/bashly/compare/v1.3.6..v1.3.7)


v1.3.6 - 2026-01-06
----------------------------------------

- Switch from `filewatcher` to `listen` [`0b32b694`](https://github.com/bashly-framework/bashly/commit/0b32b694)
- Fix filewatcher interrupt [`b3f84ae3`](https://github.com/bashly-framework/bashly/commit/b3f84ae3)
...
- Move global variable declarations after environment variable declarations [`cc5a29d8`](https://github.com/bashly-framework/bashly/commit/cc5a29d8)
- Add word_wrap option to settings [`f6d6c7da`](https://github.com/bashly-framework/bashly/commit/f6d6c7da)
...
- Add support for captuing `--help` when using `catch_all` [`26d6f19c`](https://github.com/bashly-framework/bashly/commit/26d6f19c)
- Fix local variables leaking from internal functions [`42cb20bb`](https://github.com/bashly-framework/bashly/commit/42cb20bb)
- Add `Settings.extra_lib_dirs` to allow loading files from multiple locations [`27d4305d`](https://github.com/bashly-framework/bashly/commit/27d4305d)
...
- Add misisng validation for `env_var.validate` [`55a3946d`](https://github.com/bashly-framework/bashly/commit/55a3946d)
- Fix validation running twice for environment variables [`4d7e6d68`](https://github.com/bashly-framework/bashly/commit/4d7e6d68)
- Add array syntax to `validate` [`4b3f7410`](https://github.com/bashly-framework/bashly/commit/4b3f7410)
- Add support for per-environment settings [`522d2b89`](https://github.com/bashly-framework/bashly/commit/522d2b89)
...
- Fix function name in root command comment [`5775da6f`](https://github.com/bashly-framework/bashly/commit/5775da6f)
...
- Fix render markdown command examples [`21b786d3`](https://github.com/bashly-framework/bashly/commit/21b786d3)
- Add `markdown_github` render template [`754ca508`](https://github.com/bashly-framework/bashly/commit/754ca508)
- Add ability to choose a different formatter (internal, none, shfmt) [`efc01532`](https://github.com/bashly-framework/bashly/commit/efc01532)
- Add ability to override raw input [`8048e644`](https://github.com/bashly-framework/bashly/commit/8048e644)
- Update bash version bouncer to require bash 4.2 [`3a3952ac`](https://github.com/bashly-framework/bashly/commit/3a3952ac)
- Add Command Line Manipulation example [`388ab192`](https://github.com/bashly-framework/bashly/commit/388ab192)
...
- Fix premature exit in `validate_not_empty` validation function [`b96ba359`](https://github.com/bashly-framework/bashly/commit/b96ba359)
- Add `stacktrace` standard library [`03b78561`](https://github.com/bashly-framework/bashly/commit/03b78561)
- Add examples/stacktrace [`52073cc7`](https://github.com/bashly-framework/bashly/commit/52073cc7)
...
- Drop support for Ruby 3.1 [`a735ee00`](https://github.com/bashly-framework/bashly/commit/a735ee00)
- Fix validations to only run once [`a3075a02`](https://github.com/bashly-framework/bashly/commit/a3075a02)
- Add settings for internal function names [`8fa881e2`](https://github.com/bashly-framework/bashly/commit/8fa881e2)
...
- Fix quoted heredocs [`4b264646`](https://github.com/bashly-framework/bashly/commit/4b264646)
...
- Add `header_override` command option [`d7a57e47`](https://github.com/bashly-framework/bashly/commit/d7a57e47)
- Rename `header_override` to `help_header_override` [`2a8b5ded`](https://github.com/bashly-framework/bashly/commit/2a8b5ded)
- Add example for `help_header_override` [`aa00c751`](https://github.com/bashly-framework/bashly/commit/aa00c751)
- Update JSON schema with `help_header_override` [`6677f4da`](https://github.com/bashly-framework/bashly/commit/6677f4da)
- Update `bashly doc` with `command.help_header_override` [`4e50fe17`](https://github.com/bashly-framework/bashly/commit/4e50fe17)
...
- Update colors library to support auto-colors based on TTY [`a4bbae9a`](https://github.com/bashly-framework/bashly/commit/a4bbae9a)
- Add `--quiet` to `bashly add` command [`ca0a5468`](https://github.com/bashly-framework/bashly/commit/ca0a5468)
- Update documentation domain to bashly.dev [`d05605cb`](https://github.com/bashly-framework/bashly/commit/d05605cb)
...
- Add support for avoiding execution if the script is sourced [`4d83222b`](https://github.com/bashly-framework/bashly/commit/4d83222b)
- Revert 9167c49 to allow calling `run ...` internally [`d25c718f`](https://github.com/bashly-framework/bashly/commit/d25c718f)
- Declare `version` and `long_usage` as globals for consistency and clarity of intent [`e9a9a76f`](https://github.com/bashly-framework/bashly/commit/e9a9a76f)
- Move `long_usage` definition from `initialize` to `run` [`54beb86e`](https://github.com/bashly-framework/bashly/commit/54beb86e)
- Add Internal Run example [`4a1b2b9b`](https://github.com/bashly-framework/bashly/commit/4a1b2b9b)
- Add support for whalebrew [`f33c663b`](https://github.com/bashly-framework/bashly/commit/f33c663b)
...
- Update version specifications for all dependencies [`6bf0c4a0`](https://github.com/bashly-framework/bashly/commit/6bf0c4a0)
- Add support for tweaking production/development output [`c23d7053`](https://github.com/bashly-framework/bashly/commit/c23d7053)
- Fix shellcheck unused variable on `other_args` in production [`f78c6e9a`](https://github.com/bashly-framework/bashly/commit/f78c6e9a)
- Fix view markers for user files [`cc3896ed`](https://github.com/bashly-framework/bashly/commit/cc3896ed)
- Update dependency check to show all missing dependencies at once [`49251064`](https://github.com/bashly-framework/bashly/commit/49251064)
- Add support for declaring aliases for internal global variables [`5264d511`](https://github.com/bashly-framework/bashly/commit/5264d511)
- Move global var declarations from `run()` to `initialize()` [`9167c498`](https://github.com/bashly-framework/bashly/commit/9167c498)
- Update settings JSON schema [`b4e7e4dd`](https://github.com/bashly-framework/bashly/commit/b4e7e4dd)
- Add `build` as an alias to `bashly generate` [`d64bc367`](https://github.com/bashly-framework/bashly/commit/d64bc367)
- Update default script header [`c85276cd`](https://github.com/bashly-framework/bashly/commit/c85276cd)
...
- Fix array variables scope [`ed7f2404`](https://github.com/bashly-framework/bashly/commit/ed7f2404)
...
- Move root variables from `run()` to `initialize()` [`f76c53b6`](https://github.com/bashly-framework/bashly/commit/f76c53b6)
...
- Add `command.variables` as a convenience utility for defining global command variables [`65388868`](https://github.com/bashly-framework/bashly/commit/65388868)
- Update JSON schema to include `command.variables` [`28953fb5`](https://github.com/bashly-framework/bashly/commit/28953fb5)
- Refactor `command.variables` to a new `Variable` object [`3e5a0606`](https://github.com/bashly-framework/bashly/commit/3e5a0606)
- Add black and white to color library [`0573e0f5`](https://github.com/bashly-framework/bashly/commit/0573e0f5)
...
- Fix docker image for multi-arch [`5660a3e3`](https://github.com/bashly-framework/bashly/commit/5660a3e3)
- Fix INI library when loading multiple files [`6bfb1bc0`](https://github.com/bashly-framework/bashly/commit/6bfb1bc0)
- Add sub dependencies to avoid Ruby 3.3.5 warnings [`30b7318a`](https://github.com/bashly-framework/bashly/commit/30b7318a)
- Fix `conflicts` in fixed flags [`152069af`](https://github.com/bashly-framework/bashly/commit/152069af)
...
- Add support for needy flags: `flag.needs` [`fadda94d`](https://github.com/bashly-framework/bashly/commit/fadda94d)
- Add needy flag example [`43e3b386`](https://github.com/bashly-framework/bashly/commit/43e3b386)
- Update JSON schemas [`868650c6`](https://github.com/bashly-framework/bashly/commit/868650c6)
- Update flag usage to show its conflicts and needs [`db23575c`](https://github.com/bashly-framework/bashly/commit/db23575c)
- Refactor Command#introspection [`a66db36f`](https://github.com/bashly-framework/bashly/commit/a66db36f)
- Add support for environment variable validations [`bccd3b02`](https://github.com/bashly-framework/bashly/commit/bccd3b02)
- Update validations example to show environment variable validation [`ee6a4c99`](https://github.com/bashly-framework/bashly/commit/ee6a4c99)
- Update script generation to allow bash variables in some YAML strings [`6660d168`](https://github.com/bashly-framework/bashly/commit/6660d168)
- Allow ad-hoc revealing of private commands, flags, and environment variables [`d2876d72`](https://github.com/bashly-framework/bashly/commit/d2876d72)
- Add private-reveal example [`8c940429`](https://github.com/bashly-framework/bashly/commit/8c940429)
- Update completions library to consider private visibility setting [`e16dde10`](https://github.com/bashly-framework/bashly/commit/e16dde10)
- Update mandoc/markdown library to consider private visibility setting [`c49d94df`](https://github.com/bashly-framework/bashly/commit/c49d94df)
...
- Add validation to disallow required args before optional [`f2d62764`](https://github.com/bashly-framework/bashly/commit/f2d62764)
- Fix shellcheck violations and reduce use of `eval` [`41da133a`](https://github.com/bashly-framework/bashly/commit/41da133a)
- Fix default command not being triggered when only flags are provided [`c6598300`](https://github.com/bashly-framework/bashly/commit/c6598300)
- Fix prompt in bashly shell [`de231e89`](https://github.com/bashly-framework/bashly/commit/de231e89)
...
- Fix usage string when there is a forced default command [`d50607be`](https://github.com/bashly-framework/bashly/commit/d50607be)
- Add 'Global options' caption when appropriate [`105a0f89`](https://github.com/bashly-framework/bashly/commit/105a0f89)
- Update descriptions in schemas/strings.json [`6592666f`](https://github.com/bashly-framework/bashly/commit/6592666f)
- Remove redundant code in usage function [`f87986a7`](https://github.com/bashly-framework/bashly/commit/f87986a7)
- Update default command usage to show optional brackets [`854036d5`](https://github.com/bashly-framework/bashly/commit/854036d5)
- Add `show_examples_on_error` setting [`5e58388d`](https://github.com/bashly-framework/bashly/commit/5e58388d)
- Add examples/command-examples-on-error [`b30d2aa1`](https://github.com/bashly-framework/bashly/commit/b30d2aa1)
...
- Sanitize percent signs in help messages [`1f7e27c5`](https://github.com/bashly-framework/bashly/commit/1f7e27c5)
- Drop support for Ruby 3.0 [`865d6ac7`](https://github.com/bashly-framework/bashly/commit/865d6ac7)
- Fix input normalization to ignore anything after the double dash (--) operator [`621a1513`](https://github.com/bashly-framework/bashly/commit/621a1513)
- Add `[--]` to usage text when `catch_all` is used [`1422bcf3`](https://github.com/bashly-framework/bashly/commit/1422bcf3)
- Add `conjoined_flag_args` to allow disabling the `--flag=arg` normalization [`d17756d2`](https://github.com/bashly-framework/bashly/commit/d17756d2)
...
- Fix repeatable args when the input has quotes [`0d35217b`](https://github.com/bashly-framework/bashly/commit/0d35217b)
- Fix repeatable flag args when the input has quotes [`ab34fc05`](https://github.com/bashly-framework/bashly/commit/ab34fc05)
- Improve handling of unique repeatable args and flag args [`c200223a`](https://github.com/bashly-framework/bashly/commit/c200223a)
- Update `Approvals.bash` to v0.5.1 [`8e12d559`](https://github.com/bashly-framework/bashly/commit/8e12d559)
...
- Update `approvals.bash` to v0.5.0 [`530cb05d`](https://github.com/bashly-framework/bashly/commit/530cb05d)
- Add support for using heredoc [`adf4837f`](https://github.com/bashly-framework/bashly/commit/adf4837f)
...
- Refactor validations to run after assigning default values [`e45580cd`](https://github.com/bashly-framework/bashly/commit/e45580cd)
- Upgrade `approvals.bash` to 0.4.2 [`863bf9a5`](https://github.com/bashly-framework/bashly/commit/863bf9a5)
...
- Docker: Fix missing pandoc [`b8f6d2cf`](https://github.com/bashly-framework/bashly/commit/b8f6d2cf)
- Avoid rendering `inspect_args()` when generating for production env [`dbb8816b`](https://github.com/bashly-framework/bashly/commit/dbb8816b)
- Update `approvals.bash` library to 0.4.1 [`9eee25ca`](https://github.com/bashly-framework/bashly/commit/9eee25ca)
- Update Dockerfile [`45344972`](https://github.com/bashly-framework/bashly/commit/45344972)
- Build multi-arch docker image using GitHub Actions [`5d169261`](https://github.com/bashly-framework/bashly/commit/5d169261)
...
- Allow `flag.default` and `arg.default` to be an array if `repeatable` is true [`00c81ec1`](https://github.com/bashly-framework/bashly/commit/00c81ec1)
- Improve JSON schema tests [`6bd7a1b6`](https://github.com/bashly-framework/bashly/commit/6bd7a1b6)
- Add YAML schema as a source to the bashly JSON schema [`261d1040`](https://github.com/bashly-framework/bashly/commit/261d1040)
- Add `allowed` option to `environment_variable` [`4d313a86`](https://github.com/bashly-framework/bashly/commit/4d313a86)
- Update `inspect_args` to also print managed `environment_variables` [`4fe17b71`](https://github.com/bashly-framework/bashly/commit/4fe17b71)
- Refactor `inspect_args` handling of environment variables [`7c6e7124`](https://github.com/bashly-framework/bashly/commit/7c6e7124)
...
- Fix example in `bashly doc flag.arg` [`039ab1cb`](https://github.com/bashly-framework/bashly/commit/039ab1cb)
- Add support for `unique` in repeatable flag args [`b062c934`](https://github.com/bashly-framework/bashly/commit/b062c934)
- Disallow multiple repeatable args, and a repeatable arg that is not the last one [`25431c9e`](https://github.com/bashly-framework/bashly/commit/25431c9e)
- Add support for `unique` in repeatable args [`4486788f`](https://github.com/bashly-framework/bashly/commit/4486788f)
...
- Fix `bashly completeions --install` [`9e5d45a0`](https://github.com/bashly-framework/bashly/commit/9e5d45a0)
...
- Fix shfmt excess newlines violation when using `--env production` [`0938fca1`](https://github.com/bashly-framework/bashly/commit/0938fca1)
- Fix some incompatibilities with strict mode [`b24cddff`](https://github.com/bashly-framework/bashly/commit/b24cddff)
...
- Upgrade `approvals.bash` library to version 0.4.0 [`a68ad34f`](https://github.com/bashly-framework/bashly/commit/a68ad34f)
- Update INI library to allow using environment variables in the INI values [`2e3aec7f`](https://github.com/bashly-framework/bashly/commit/2e3aec7f)
- Add support for custom "See Also" in mandoc renderer (`x_mandoc_see_also`) [`4fddc7bf`](https://github.com/bashly-framework/bashly/commit/4fddc7bf)
- Fix missing tmpdir library in `bashly add --source` [`3f7b4c3a`](https://github.com/bashly-framework/bashly/commit/3f7b4c3a)
- Validate libraries.yml [`a44cbde9`](https://github.com/bashly-framework/bashly/commit/a44cbde9)
...
- Add `bashly render` command [`4acc67bd`](https://github.com/bashly-framework/bashly/commit/4acc67bd)
- Add ability to render markdown documentation [`7db61291`](https://github.com/bashly-framework/bashly/commit/7db61291)
- Refactor module loading with autoload [`62184f0f`](https://github.com/bashly-framework/bashly/commit/62184f0f)
- Add `bashly add render_markdown` library [`d0fada7d`](https://github.com/bashly-framework/bashly/commit/d0fada7d)
- Add ability to render man pages and `bashly add render_mandoc` library [`fe9607b4`](https://github.com/bashly-framework/bashly/commit/fe9607b4)
- Refactor render command with RenderSource model [`8629d266`](https://github.com/bashly-framework/bashly/commit/8629d266)
- Allow arbitrary (`x-anything`) values in bashly.yml [`90627833`](https://github.com/bashly-framework/bashly/commit/90627833)
- Refactor mandoc template to use x_mandoc_footer and x_mandoc_authors [`b44b91f9`](https://github.com/bashly-framework/bashly/commit/b44b91f9)
- Add render-mandoc man page generation example [`98420de1`](https://github.com/bashly-framework/bashly/commit/98420de1)
- Add `--show` to `bashly render` [`2fcd790b`](https://github.com/bashly-framework/bashly/commit/2fcd790b)
...
- Add support for git-sourced libraries [`bcd35dc`](https://github.com/bashly-framework/bashly/commit/bcd35dc)
...
- Add ability to catch arbitrary args and flags [`9e7800b`](https://github.com/bashly-framework/bashly/commit/9e7800b)
...
## [v0.3.8](https://github.com/bashly-framework/bashly/tree/v0.3.8) (2020-03-02)
...
[Full Changelog](https://github.com/bashly-framework/bashly/compare/v0.3.2...v0.3.3)
...
[Full Changelog](https://github.com/bashly-framework/bashly/compare/v0.2.3...v0.2.4)
...
## [v0.2.1](https://github.com/bashly-framework/bashly/tree/v0.2.1) (2019-11-21)
