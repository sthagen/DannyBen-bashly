describe Commands::Add do
  ...
  describe 'add completions' do
    ...
    it 'creates lib/send_completions.sh' do
      ...
      content = File.read("#{source_dir}/lib/send_completions.sh")
  ...
  describe 'add completions_script' do
    it 'creates completions.bash' do
      ...
      content = File.read("#{target_dir}/completions.bash")

      expect(content).to include '# cli completion'
      expect(content).to include 'generated by'
      expect(content).to include 'completely'
      expect(content).to include 'complete -F _cli_completions cli'
    end
  end
